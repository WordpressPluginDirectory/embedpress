...
- Improved: Google private calendar connection process.
- Fixed: Dailymotion embed issue.
- Fixed: YouTube Block video embed issue in Gutenberg.
- Fixed: Vimeo Block video embed issue in Gutenberg.
- Fixed: YouTube player configuration error in the editor for WordPress 7.
- Few minor bug fixes and improvements.

= [4.5.2] – 2026-05-07 =
- Fixed: YouTube channel embeds not loading correctly.
- Improved: Live Custom Player preview in the Gutenberg editor.
- Improved: Security enhancements based on a Wordfence report.
- Few minor bug fixes and improvements.
...
- Added: ACF support for shortcodes.
- Improved: Optimized asset loading for better performance.
- Few minor bug fixes and stability improvements.

= [4.4.10] – 2026-02-19 =
- Fixed: Fullscreen issue for embedded PowerPoint (PPTX) files.
- Fixed: Custom player not loading on the first attempt in Elementor.
- Fixed: YouTube responsiveness issue in Gutenberg.
- Fixed: Unwanted border around embedded Flourish graphs.
- Few minor bug fixes and improvements.
...
- Fixed: Undefined Array Key Warnings in Analytics.
- Fixed: Global Settings aren't working on elementor
- Few minor bug fixes and improvements.
...
- Fixed: Google Photos carousel layout wasn't redirecting to the Google album page.
- Fixed: Border style wasn't working on Gutenberg Embedded Documents block.
- Fixed: Height & width rendering wasn't working properly for CodeSandbox embeds.
- Few minor bug fixes & improvements
